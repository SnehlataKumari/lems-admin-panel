...
export class TestService {
  ...
  async addTest(formData) {
    ...
    this.router.navigate(['home', testId, 'test-setting']);
  }
  ...
  async setHasAcceptedRegistrationRequest(test, isApproved) {
    const url = `/test/${test._id}`;
    return await this.api.put(url, { isApproved }).toPromise();
  }
